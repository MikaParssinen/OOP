    ...
    public partial class Snake : Form
    {
        ...
        private void Snake_KeyDown(object? sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                ...
                //Player 3 controls
                case Keys.T:
                    if (engine.Player3.CurrentDirection != Direction.Down)
                        engine.Player3.CurrentDirection = Direction.Up;
                    break;
                case Keys.F:
                    if (engine.Player3.CurrentDirection != Direction.Right)
                        engine.Player3.CurrentDirection = Direction.Left;
                    break;
                case Keys.G:
                    if (engine.Player3.CurrentDirection != Direction.Up)
                        engine.Player3.CurrentDirection = Direction.Down;
                    break;
                case Keys.H:
                    if (engine.Player3.CurrentDirection != Direction.Left)
                        engine.Player3.CurrentDirection = Direction.Right;
                    break;
        ...
        private void Engine_ScoreChanged(object sender, ScoreEventArgs e)
        {
            ...
            Player3Score.Text = "Score: " + e.Player3Score.ToString();
        }
